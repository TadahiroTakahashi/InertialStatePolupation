...
Load atomic transition rates from the NIST database and generate a matrix in Excel.
Calculate the population ratio within the atomic internal states using the matrix described in Excel.
